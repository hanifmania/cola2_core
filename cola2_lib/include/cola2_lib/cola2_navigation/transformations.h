...
namespace transformations
{
     ...
     */
    Eigen::Vector3d
    position( const Eigen::Vector3d measured_position,
     ...
     */
    Eigen::Vector3d
    landmarkPosition( const Eigen::Vector3d measured_landmark_position,
     ...
     */
    Eigen::Quaterniond
    orientation( const Eigen::Quaterniond measured_orientation,
                 const Eigen::Quaterniond rotation_from_origen )
    {
     ...
     */
    Eigen::Quaterniond
    landmarkOrientation( const Eigen::Quaterniond measured_landmark_orientation,
                         const Eigen::Quaterniond rotation_from_origen )
    {
     ...
     */
    Eigen::Vector3d
    linearVelocity( const Eigen::Vector3d measured_linear_velocity,
     ...
     */
    Eigen::Vector3d
    angularVelocity( const Eigen::Vector3d measured_angular_velocity,
                     const Eigen::Quaterniond rotation_from_origen )
    {
     ...
     */
    Eigen::Matrix3d
    positionCovariance( const Eigen::Matrix3d measured_position_covariance,
                        ...
                        const Eigen::Vector3d translation_from_origin )
    {
        ...
        return ( measured_position_covariance +
                 rpy_cov * origen_orientation_covariance * rpy_cov.transpose() );
    }
     ...
     */
    Eigen::Matrix3d
    linearVelocityCov( const Eigen::Matrix3d measured_linear_velocity_covariance,
     ...
     */
    Eigen::Matrix3d
    rotatedCovariance( const Eigen::Matrix3d covariance,
