#ifndef __EKF_ROS_BASE__
#define __EKF_ROS_BASE__
...
public:
    ...
    void
    checkDiagnostics( const ros::TimerEvent& e )
    {
    ...
    void
    checkFrameId( std::string frame_id )
    {
    ...
    Eigen::Vector3d
    getPositionIncrementFrom( double time )
    {
        unsigned int i = 0;
