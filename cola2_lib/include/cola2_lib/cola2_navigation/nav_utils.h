#ifndef __NAV_UTILS__
#define __NAV_UTILS__
...
double
dms2Deg( const double degree_minutes,
...
double
dms2DegInt( const double degree_minutes,
         const int hemisphere )
{
    switch( hemisphere ) {
        case 0:
            return dms2Deg( degree_minutes, char('N') );
        case 1:
            return dms2Deg( degree_minutes, char('S') );
        case 2:
            return dms2Deg( degree_minutes, char('W') );
        case 3:
            return dms2Deg( degree_minutes, char('E') );
        default:
